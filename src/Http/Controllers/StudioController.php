...
use BtyBugPlugins\Studios\Models\Classes;
use BtyBugPlugins\Studios\Models\StudioClasses;
use Illuminate\Http\Request;
use App\Http\Requests;
use App\Http\Controllers\Controller;
use BtyBugPlugins\Studios\Models\Studios;
...
class StudioController extends Controller
{
    public function getIndex(Request $request)
    {
        ...
        return view("studios::create", compact(['groups', 'type', 'data']));
    }
...
//        $globals = Classes::$getGlobalClasses;
        ...
        if (!\File::exists(base_path(Studios::$viewFolderPath . DS . $type . DS . $studio . '.blade.php'))) abort(404);
