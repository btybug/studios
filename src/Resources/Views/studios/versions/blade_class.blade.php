    ...
    <div class="menuBuilder textBuilderPreview">
        <section class="container-fluid">
            <div class="row " id="builderContain">
                <div class="col-xs-12 col-sm-6 previewAray" class="text-center">
                    ...
                    <div class="col-xs-12">
                        <div class="flat-area" data-previewclass>
                            @include("framework::UnitCreator._partials.".$data["id"].".".$data["id"])
                        </div>
                        <div class="hide" data-previewblade="origenl">
                            {!! $data['css_data'] !!}
                        </div>
                        <div class="p-t-20">
                    ...
                    <textarea name="json_data" class="form-control" data-export="json"
                              style="margin-top:100px">{!! $data['json_data'] or null !!}</textarea>
                ...
                @include('studios::_partial.component.html.option_blade_class')
            </div>
        </section>
    </div>
    ...
    <script type="template" data-template="listingrow">
        <div class="listinginfo" data-listing="row" data-rowid="{rowid}">
            <div class="lsitingbutton">
                <div class="btn-group">
                    <button type="button" class="btn dropdown-toggle" data-cssselector="{csstarget}"
                            data-caction="cssselector" data-id="{rowid}" data-toggle="dropdown"><i class="fa fa-css3"
                                                                                                   aria-hidden="true"></i>
                    </button>
...
@section('JS')
    {!! BBscript(module_path('Studios/src/Resources/Views/assets/js/studio-plugin-new.js')) !!}
    ...
    {!! HTML::script('/app/Modules/Studios/Resources/Views/assets/component/unitmaker-builder.js?v=0.76') !!}
@stop