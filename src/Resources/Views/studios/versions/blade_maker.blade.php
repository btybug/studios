...
@section('CSS')
    ...
    {!! BBstyle(module_path('studios/src/Resources/Views/assets/component/componetcss.css')) !!}
    {!! BBstyle(module_path('studios/src/Resources/Views/public/js/bootstrap-fileinput/css/fileinput.min.css')) !!}
    <style>
        .editcontianer {
            position: relative;
            width: 100%;
...
@stop
@section('JS')
    {!! BBscript(module_path('studios/src/Resources/Views/public/js/bootstrap-fileinput/js/fileinput.min.js')) !!}
    {!! BBscript(module_path('studios/src/Resources/Views/assets/js/studio-plugin-new.js')) !!}
    {!! BBscript(module_path('studios/src/Resources/Views/assets/component/blademaker-builder.js')) !!}
